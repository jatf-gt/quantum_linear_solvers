...
class LinearSystemObservable(ABC):
    ...
    def observable(self, num_qubits: int) -> Union[Operator, List[Operator]]:
        ...
        Returns:
            The observable as an Operator or list of Operators.
        """
    ...
    def observable_circuit(
        ...
        Returns:
            The observable as a QuantumCircuit or list of QuantumCircuits.
        """
        raise NotImplementedError
    ...
    def post_processing(
        ...
        Args:
            solution: The probability or expectation value calculated from the circuit and the observable.
